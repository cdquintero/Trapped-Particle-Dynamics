...
T=St.K
Tau_bounce4=(domL*St.Re)/(mth.sqrt(T/St.m))*(3.7-1.6*mth.sin(St.pitch_angle*np.pi/180))
...
ax.plot(domL,Tau_bounce2, color = 'r', label= '%1.1f MeV' % 30.0)
ax.scatter(domL,Tau_Bounce2, c='cyan', s=40, linewidths='0.7')          

ax.plot(domL,Tau_bounce3, color = '#ff69b4', label= '%1.1f MeV' % 50.)
ax.scatter(domL,Tau_Bounce3, c='y', s=40, linewidths='0.7')
    
ax.plot(domL,Tau_bounce4, color = '#000000', label= '%1.1f MeV' % 100.0)
ax.scatter(domL,Tau_Bounce4, c='b', s=40, linewidths='0.7')
...
#outputname = 'Periodo_simGC4.txt'

#archivo=open(outputname,'w')

#for i in Tau_Bounce4:
#    archivo.write(str(i) + '\n')
